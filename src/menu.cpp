...
static std::string instructions[] = {
	...
	"and so are more difficult to reach in time.",
	"",
	"Your score consists of 3 numbers, one blue, one yellow and one red.",
	"Reaching a checkpoint awards " + std::to_string(TARGET_BASE_PTS) + " points + " + std::to_string(TARGET_TIME_PTS) + " per second remaining",
	"of the same color as the checkpoint.",
	"",
	"Scores are ordered first by the number of red points,",
	"second by the number of yellow points,",
	"and third by the number of blue points.",
	"",
	"Controls:",
	">W/S - Pitch down / up",
	">A/D - Bank left / right",
